...
auto main(int argc, char** argv) -> int {
	...
	loop.add_animation("animation1", std::make_shared<RectAnimation>(std::make_shared<PCircle>(50, 50, 8)));
	...
	path.loop(true);
	loop.add_animation("animation2", std::make_shared<PathAnimation>(std::make_shared<PRect>(200, 200, 16, 16),
